            ...
            children: [
                      ...
                      : SfCartesianChart(
                          ...
                          series: <CandleSeries>[
                            CandleSeries<CoinChartModel, int>(
                              ...
                              dataSource:
                                  selectedCoinPageController.coinChartList,
                              xValueMapper: (CoinChartModel sales, _) =>
                                  sales.time,
                              lowValueMapper: (CoinChartModel sales, _) =>
                                  sales.low,
                              highValueMapper: (CoinChartModel sales, _) =>
                                  sales.high,
                              openValueMapper: (CoinChartModel sales, _) =>
                                  sales.open,
                              closeValueMapper: (CoinChartModel sales, _) =>
                                  sales.close,
              ...
              Container(
                ...
                child: ListView.builder(
                  ...
                  itemCount: selectedCoinPageController.intervalMap.length,
                  itemBuilder: (context, index) {
                    String key = selectedCoinPageController.intervalMap.keys
                        .elementAt(index);
                    return GestureDetector(
                      onTap: () async {
                        selectedCoinPageController.selectedIndex.value = index;
                        await selectedCoinPageController.getCoinChart(
                            data.id,
                            selectedCoinPageController.intervalMap.values
              ...
              aboutCoinData("Total Supply", data.totalSupply.toString()),
